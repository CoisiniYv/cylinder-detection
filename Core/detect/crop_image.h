 ...
 * @param enableFourSideCrop 是否启用四边裁剪
 * @param x 裁剪区域的左上角 x 坐标
 * @param y 裁剪区域的左上角 y 坐标
 * @param width 裁剪区域的宽度
 * @param height 裁剪区域的高度
 * @param isQw 是否裁剪QW区域，可选，默认false
 * @param x1Circle 第一个圆中心点对于原图的x位置，可选，默认-1
 * @param y1Circle 第一个圆中心点对于原图的y位置，可选，默认-1
 * @param x2Circle 第二个圆中心点对于原图的x位置，可选，默认-1
 * @param y2Circle 第二个圆中心点对于原图的y位置，可选，默认-1
 * @param radius 圆裁剪区域的半径，可选，默认-1
